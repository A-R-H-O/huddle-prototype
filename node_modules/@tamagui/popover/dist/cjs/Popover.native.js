...
function PopoverContentPortal(props) {
  var { __scopePopover } = props, zIndex = props.zIndex, context = usePopoverContext(__scopePopover), popperContext = (0, import_popper.usePopperContext)(__scopePopover || POPOVER_SCOPE), themeName = (0, import_core.useThemeName)(), adaptContext = (0, import_adapt.useAdaptContext)(), contents = props.children;
...
var PopoverContentImpl = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  return context.breakpointActive ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_adapt.AdaptPortalContents, {
...
var PopoverClose = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
...
}), PopoverScrollView = /* @__PURE__ */ React.forwardRef(function(props, ref) {
...
}), Popover = (0, import_helpers.withStaticProperties)(/* @__PURE__ */ React.forwardRef(function(props, ref) {
  var id = React.useId();
  ...
  var { children, open: openProp, defaultOpen, onOpenChange, __scopePopover, keepChildrenMounted, hoverable, disableFocus, id, ...restProps } = props, triggerRef = React.useRef(null), [hasCustomAnchor, setHasCustomAnchor] = React.useState(!1), viaRef = React.useRef(void 0), [open, setOpen] = (0, import_use_controllable_state.useControllableState)({
    prop: openProp,
