...
const POPOVER_SCOPE = "PopoverScope", PopoverContext = (0, import_core.createStyledContext)({}), usePopoverContext = PopoverContext.useStyledContext, PopoverAnchor = React.forwardRef(function(props, forwardedRef) {
  ...
  React.forwardRef(function(props, forwardedRef) {
    ...
    }, [context.open]), !context.keepChildrenMounted && isFullyHidden ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContentPortal, { __scopePopover, zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_core.Stack,
      {
...
function PopoverRepropagateContext(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_popper.PopperContext.Provider, { scope: props.scope, ...props.popperContext, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContext.Provider, { ...props.context, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_adapt.ProvideAdaptContext, { ...props.adaptContext, children: props.children }) }) });
}
function PopoverContentPortal(props) {
  const { __scopePopover } = props, zIndex = props.zIndex, context = usePopoverContext(__scopePopover), popperContext = (0, import_popper.usePopperContext)(__scopePopover || POPOVER_SCOPE), themeName = (0, import_core.useThemeName)(), adaptContext = (0, import_adapt.useAdaptContext)();
  ...
  )), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_portal.Portal, { stackZIndex: !0, zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_core.Theme, { forceClassName: !0, name: themeName, children: [
...
const PopoverContentImpl = React.forwardRef(function(props, forwardedRef) {
  ...
  let contents = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_animate_presence.ResetPresence, { children });
  return context.breakpointActive ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_adapt.AdaptPortalContents, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
  ...
  const {
    ...
    id,
    ...restProps
  } = props, triggerRef = React.useRef(null), [hasCustomAnchor, setHasCustomAnchor] = React.useState(!1), viaRef = React.useRef(void 0), [open, setOpen] = (0, import_use_controllable_state.useControllableState)({
    prop: openProp,
