...
const POPOVER_SCOPE = "PopoverScope", PopoverContext = createStyledContext({}), usePopoverContext = PopoverContext.useStyledContext, PopoverAnchor = React.forwardRef(function(props, forwardedRef) {
  ...
  return context.hasCustomAnchor ? trigger : /* @__PURE__ */ jsx(
    PopperAnchor,
    {
  ...
  React.forwardRef(function(props, forwardedRef) {
    ...
    }, [context.open]), !context.keepChildrenMounted && isFullyHidden ? null : /* @__PURE__ */ jsx(PopoverContentPortal, { __scopePopover, zIndex, children: /* @__PURE__ */ jsx(
      Stack,
      {
...
function PopoverRepropagateContext(props) {
  return /* @__PURE__ */ jsx(PopperContext.Provider, { scope: props.scope, ...props.popperContext, children: /* @__PURE__ */ jsx(PopoverContext.Provider, { ...props.context, children: /* @__PURE__ */ jsx(ProvideAdaptContext, { ...props.adaptContext, children: props.children }) }) });
}
function PopoverContentPortal(props) {
  const { __scopePopover } = props, zIndex = props.zIndex, context = usePopoverContext(__scopePopover), popperContext = usePopperContext(__scopePopover || POPOVER_SCOPE), themeName = useThemeName(), adaptContext = useAdaptContext();
  ...
  return (Platform.OS === "android" || Platform.OS === "ios") && (contents = /* @__PURE__ */ jsx(
  ...
  )), /* @__PURE__ */ jsx(Portal, { stackZIndex: !0, zIndex, children: /* @__PURE__ */ jsxs(Theme, { forceClassName: !0, name: themeName, children: [
    ...
    /* @__PURE__ */ jsx(StackZIndexContext, { zIndex: resolveViewZIndex(zIndex), children: contents })
  ] }) });
}
const PopoverContentImpl = React.forwardRef(function(props, forwardedRef) {
  ...
  let contents = /* @__PURE__ */ jsx(ResetPresence, { children });
  return context.breakpointActive ? /* @__PURE__ */ jsx(AdaptPortalContents, { children: /* @__PURE__ */ jsx(
  ...
  function(props, forwardedRef) {
    ...
    return useAdaptIsActive() ? null : /* @__PURE__ */ jsx(
      PopperArrow,
      {
        __scopePopper: __scopePopover || POPOVER_SCOPE,
  ...
  React.forwardRef(
    function(props, ref) {
      ...
      return /* @__PURE__ */ jsx(AdaptParent, { scope: `${id}PopoverContents`, portal: !0, children: /* @__PURE__ */ jsx(PopoverInner, { ref, id, ...props }) });
    }
  ),
  {
  ...
  const {
    ...
    id,
    ...restProps
  } = props, triggerRef = React.useRef(null), [hasCustomAnchor, setHasCustomAnchor] = React.useState(!1), viaRef = React.useRef(void 0), [open, setOpen] = useControllableState({
    prop: openProp,
