...
import { Stack, Theme, View, useCreateShallowSetState, createStyledContext, useEvent, useGet, useThemeName } from "@tamagui/core";
...
var PopoverContentImpl = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  var { trapFocus, __scopePopover, onOpenAutoFocus, onCloseAutoFocus, disableOutsidePointerEvents, disableFocusScope, onEscapeKeyDown, onPointerDownOutside, onFocusOutside, onInteractOutside, children, disableRemoveScroll, freezeContentsWhenHidden, setIsFullyHidden, lazyMount, ...contentProps } = props, context = usePopoverContext(__scopePopover), { open, keepChildrenMounted } = context, popperContext = usePopperContext(__scopePopover || POPOVER_SCOPE), handleExitComplete = React.useCallback(function() {
  ...
  return context.breakpointActive ? /* @__PURE__ */ _jsx(AdaptPortalContents, {
...
var PopoverClose = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  ...
  var { children, open: openProp, defaultOpen, onOpenChange, __scopePopover, keepChildrenMounted, hoverable, disableFocus, id, ...restProps } = props, triggerRef = React.useRef(null), [hasCustomAnchor, setHasCustomAnchor] = React.useState(!1), viaRef = React.useRef(void 0), [open, setOpen] = useControllableState({
    prop: openProp,
