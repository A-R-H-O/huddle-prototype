...
var import_jsx_runtime = require("react/jsx-runtime"), import_use_presence = require("@tamagui/use-presence"), import_core = require("@tamagui/core"), import_author = require("moti/author"), import_react = __toESM(require("react")), import_react_native_reanimated = __toESM(require("react-native-reanimated"));
function createTamaguiAnimatedComponent() {
  var defaultTag = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "div", isText = defaultTag === "span", Component = import_react_native_reanimated.default.createAnimatedComponent(/* @__PURE__ */ (0, import_react.forwardRef)(function(propsIn, ref) {
    var _hooks_usePropsTransform, { forwardedRef, animation, tag = defaultTag, ...propsRest } = propsIn, hostRef = (0, import_react.useRef)(null), composedRefs = (0, import_core.useComposedRefs)(forwardedRef, ref, hostRef), stateRef = (0, import_react.useRef)(null);
    stateRef.current || (stateRef.current = {
      get host() {
        return hostRef.current;
      }
    });
    var [_, state] = (0, import_core.useThemeWithState)({}), result = (0, import_core.getSplitStyles)(propsRest, isText ? import_core.Text.staticConfig : import_core.View.staticConfig, state == null ? void 0 : state.theme, state == null ? void 0 : state.name, {
      unmounted: !1
    }, {
      isAnimated: !1,
      noClass: !0
    }), props = result.viewProps, Element = tag, transformedProps = (_hooks_usePropsTransform = import_core.hooks.usePropsTransform) === null || _hooks_usePropsTransform === void 0 ? void 0 : _hooks_usePropsTransform.call(import_core.hooks, tag, props, stateRef, !1);
...
function createAnimations(animations) {
  return {
    View: import_core.isWeb ? AnimatedView : import_react_native_reanimated.default.View,
    Text: import_core.isWeb ? AnimatedText : import_react_native_reanimated.default.Text,
    // View: Animated.View,
    // Text: Animated.Text,
    isReactNative: !0,
    supportsCSSVars: !1,
