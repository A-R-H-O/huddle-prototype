...
const SelectViewportFrame = styled(ThemeableStack, {
  ...
  function(props, forwardedRef) {
    const { __scopeSelect, children, disableScroll, ...viewportProps } = props, context = useSelectContext(VIEWPORT_NAME, __scopeSelect), itemContext = useSelectItemParentContext(VIEWPORT_NAME, __scopeSelect), isAdapted = useAdaptIsActive(), composedRefs = useComposedRefs(
    ...
    if (isAdapted || !isWeb)
      return /* @__PURE__ */ jsx(AdaptPortalContents, { children: /* @__PURE__ */ jsx(
        ForwardSelectContext,
        {
          __scopeSelect,
          itemContext,
