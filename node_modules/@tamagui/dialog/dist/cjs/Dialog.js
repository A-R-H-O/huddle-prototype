...
const DIALOG_NAME = "Dialog", [createDialogContext, createDialogScope] = (0, import_create_context.createContextScope)(DIALOG_NAME), [DialogProvider, useDialogContext] = createDialogContext(DIALOG_NAME), TRIGGER_NAME = "DialogTrigger", DialogTriggerFrame = (0, import_core.styled)(import_core.View, {
  ...
  const { __scopeDialog, children, space, spaceDirection, separator } = props, themeName = (0, import_core.useThemeName)(), context = useDialogContext(PORTAL_NAME, props.__scopeDialog), isAdapted = (0, import_adapt.useAdaptIsActive)();
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogProvider, { scope: __scopeDialog, ...context, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core.Theme, { name: themeName, children: childrenSpaced }) });
  return isAdapted ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_adapt.AdaptPortalContents, { children: content }) : context.modal ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_portal.PortalItem, { hostName: context.modal ? "root" : context.adaptName, children: content }) : content;
}, DialogPortal = (props) => {
  ...
  return import_constants.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_portal.Portal,
    {
      zIndex,
      stackZIndex: 1e3,
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PassthroughTheme, { children: framedContents })
    }
  ) : isAdapted ? framedContents : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogPortalItem, { __scopeDialog, children: framedContents });
  ...
  ({ children, context, ...props }, forwardedRef) => {
    ...
    return React.useEffect(() => {
      if (!import_constants.isWeb || !context.open) return;
