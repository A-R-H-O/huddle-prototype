...
import { Theme, View, getExpandedShorthand, spacedChildren, styled, useThemeName } from "@tamagui/core";
...
var DIALOG_NAME = "Dialog", [createDialogContext, createDialogScope] = createContextScope(DIALOG_NAME), [DialogProvider, useDialogContext] = createDialogContext(DIALOG_NAME), TRIGGER_NAME = "DialogTrigger", DialogTriggerFrame = styled(View, {
  ...
  var { __scopeDialog, children, space, spaceDirection, separator } = props, themeName = useThemeName(), context = useDialogContext(PORTAL_NAME, props.__scopeDialog), isAdapted = useAdaptIsActive(), childrenSpaced = children;
  ...
  var content = /* @__PURE__ */ _jsx(DialogProvider, {
    scope: __scopeDialog,
    ...context,
  ...
  var { __scopeDialog, trapFocus, onOpenAutoFocus, onCloseAutoFocus, disableOutsidePointerEvents, onEscapeKeyDown, onPointerDownOutside, onFocusOutside, onInteractOutside, context, ...contentProps } = props, contentRef = React.useRef(
    ...
    void 0
  ), composedRefs = useComposedRefs(forwardedRef, contentRef), isAdapted = useAdaptIsActive();
  if (isAdapted)
