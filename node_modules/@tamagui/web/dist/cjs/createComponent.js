...
` && console.error(
    ...
    if (process.env.NODE_ENV === "development" && time && time`context-override`, startedUnhydrated && (content = (0, import_wrapStyleTags.wrapStyleTags)(Object.values(splitStyles.rulesToInsert), content)), process.env.NODE_ENV === "development" && time && time`style-tags`, process.env.NODE_ENV === "development" && debugProp && debugProp !== "profile") {
  ...
  function styleable(Component2, options) {
    let out = import_constants.IS_REACT_19 && typeof Component2 == "function" || Component2.render?.length === 2 ? Component2 : import_react.default.forwardRef(Component2);
